    ...
    <div class="loginBox_left">
      ...
      <div class="loginPanel">
        ...
        <div class="loginPanel_content">
          ...
          <div class="loginPanel_title">登录</div>

          <el-form ref="loginFormRef" :model="user_login_form" :rules="rules" class="login_form">

            <el-form-item class="login_row" prop="username">
              <div class="login_form_title">Steam 帐户名称</div>
              <el-input class="text_field" v-model="user_login_form.username" type="text" name="username"></el-input>
            </el-form-item>
            ...
            <el-form-item>
              <el-button type="submit" class="loginButton" @click="login()">注册</el-button>
          </el-form-item>
    ...
    login(){
      this.$refs.loginFormRef.validate((valid)=>{
          if(valid){
              ...
              // 访问后台
              this.axios.get('http://localhost:9000/login',{
                  'username':username,
                  'password':password,
