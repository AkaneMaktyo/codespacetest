<template>
<div class="gamePanelMax">
  <div class="gamePanelMax_title">精选和推荐</div>
  <div class="swiper_box">
    <swiper v-bind:options="swiper_box.swiperOptions">
      <swiper-slide v-for="(item,index) in swiperSlideList" :key="index">
        <div class="gamePanelMax_content">
          <img class="img0" :src="item.img0" :alt="item.name">
          <div class="gamePanelMax_content_attachment" >
            <div class="gamePanelMax_content_name">{{ item.name }}</div>
            <div class="gamePanelMax_content_screenshot">
              <div class="gamePanelMax_content_screenshot_item" @mouseover="viewImage()">
                <img :src="item.img1" >
              </div>
              <div class="gamePanelMax_content_screenshot_item">
                <img :src="item.img2">
              </div>
              <div class="gamePanelMax_content_screenshot_item">
                <img :src="item.img3">
            ...
            <div class="gamePanelMax_content_state">
              <div class="game_state">现已推出</div>
              <div class="game_classification">{{ item.classification }}</div>
            </div>
            <div class="gamePanelMax_content_bottom">
              <div v-show="item.discount == 1" class="gamePanelMax_content_price">￥ {{ item.price }}</div>
              <!-- 打折信息 -->
              <div v-show="item.discount != 1" class="gamePanelMax_content_price_discount">
                <div class="discount">-{{ 100-(item.discount*100) }}%</div>
                <div class="original_price">￥{{ item.price }}</div>
                ￥{{ item.price*item.discount|numFilter }}
              </div>
              <!-- 平台图标切换，支持win和苹果 -->
              <div class="gamePanelMax_content_platform" v-show="item.platform=='1'">
                <i class="fa fa-windows" aria-hidden="true"></i>
              </div>
              <div class="gamePanelMax_content_platform" v-show="item.platform=='2'">
                <i class="fa fa-apple" aria-hidden="true"></i>
              </div>
              <div class="gamePanelMax_content_platform" v-show="item.platform=='3'">
                <i class="fa fa-windows" aria-hidden="true"></i> <i class="fa fa-apple" aria-hidden="true"></i>
              </div>

            </div>
            <!-- 右侧弹出层 -->
            <div class="gamePanelMax_content_popUp">
              <div class="game_info">
...
<style lang="scss">
  ...
  .gamePanelMax{
    ...
    .gamePanelMax_content{
      ...
      .gamePanelMax_content_attachment{
        width: 325px;
        height: 353px;
        z-index: -1;
        display: inline-block;
        ...
        /* ！！！！！！！！！！！！！！！！！！！！！！！！就是这里的问题 */
        &:hover>.gamePanelMax_content_popUp{
          opacity: 1;
          visibility: visible;
          //transition: opacity 0.25s;
        }

        .gamePanelMax_content_popUp{
          //transition: opacity 0.25s;
          // z-index: ;
          visibility:hidden;
          //opacity: 1;
        ...
        .gamePanelMax_content_screenshot{
          width: 344px;
          height: 160px;
          ...
          top: 79px;
          right: -2px;
          .gamePanelMax_content_screenshot_item{
            width: 162px;
            height: 69px;
            display: inline-block;
            opacity: 0.6;
        ...
        .gamePanelMax_content_bottom{
          position: relative;
          top: 276px;
          right: -14px;
          color: white;
          width: 300px;
          .gamePanelMax_content_price{
            display: inline-block;
            font-size: 12px;
            color: #acdbf5;
            text-space: 20;
          }
          .gamePanelMax_content_price_discount{
            display: inline-block;
            font-size: 12px;
            width: 150px;
            word-spacing: .1em;
